...
static UART_BACKUP_STRUCT  UART_backup;
    ...
    /*******************************************************************************
    * Function Name: UART_DP_Interrupt
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    CY_ISR(UART_DP_ISR)
    {
        ...
        CY_GET_REG8(UART_DP_INTSTAT_PTR);
...
void UART_Suspend(void) 
{
    ...
    if((CY_GET_REG8(UART_CR0_PTR) & UART_CR0_ENABLE) != 0u)
    {   /* USB block is enabled */
        ...
        UART_PM_USB_CR0_REG &=
                                (uint8)~(UART_PM_USB_CR0_PD_N | UART_PM_USB_CR0_PD_PULLUP_N);
        ...
        UART_backup.mode = UART_CR1_REG & UART_CR1_REG_ENABLE;
    ...
    /* Set the DP Interrupt for wake-up from sleep mode. */
        ...
        CyIntSetPriority(UART_DP_INTC_VECT_NUM, UART_DP_INTC_PRIOR);
